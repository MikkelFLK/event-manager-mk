...
class Admin extends BaseController
{
    ...
    public function setSubPages()
    {
        $this->subpages = array(
            array(
               'parent_slug' => 'event_manager_mk',
               'page_title' => 'Event list',
               'menu_title' => 'Event list',
               'capability' => 'manage_options',
               'menu_slug' => 'event_manager_cpt',
    ...
    public function setSettings()
	{
		$args = array(
			array(
				'option_group' => 'event_cpt_settings',
	...
	{
        $options = get_option('event_plugin_cpt');
